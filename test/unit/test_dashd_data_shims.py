...
# TODO: remove fixtures below here once test_SHIM_serialise_for_machinecoind removed
...
def test_extract_object():
    ...
    expected = {
        ...
        'url': 'https://www.machinecoincentral.org/black-pearl',
