...
def mn_list():
    ...
    masternodelist_json = {
        u'701854b26809343704ab31d1c45abc08f9f83c5c2bd503a9d5716ef3c0cda857-1': {'status': "ENABLED"},
        u'f68a2e5d64f4a9be7ff8d0fbd9059dcd3ce98ad7a19a9260d1d6709127ffac56-1': {'status': "ENABLED"},
        u'656695ed867e193490261bea74783f0a39329ff634a10a9fb6f131807eeca744-1': {'status': "ENABLED"},
    }

    mnlist = [Masternode(outpoint, mnobj) for (outpoint, mnobj) in masternodelist_json.items()]
