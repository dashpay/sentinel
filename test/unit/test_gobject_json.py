...
@pytest.fixture(name="proposal_hex_old")
def proposal_hex_old_fixture():
    return proposal_hex_old()
...
@pytest.fixture(name="proposal_hex_new")
def proposal_hex_new_fixture():
    return proposal_hex_new()
...
@pytest.fixture(name="trigger_hex_old")
def trigger_hex_old_fixture():
    return trigger_hex_old()
...
@pytest.fixture(name="trigger_hex_new")
def trigger_hex_new_fixture():
    return trigger_hex_new()
