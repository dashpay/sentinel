...
def test_proposal_is_valid(proposal):
    ...
    proposal.url = 'http://machinecoincentral.org/dean-miller 5493'
    assert proposal.is_valid() is False

    proposal.url = 'http://machinecoincentralisé.org/dean-miller-5493'
    assert proposal.is_valid() is True

    proposal.url = 'http://machinecoincentralisé.org/dean-миллер-5493'
    assert proposal.is_valid() is True
